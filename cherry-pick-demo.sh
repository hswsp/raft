...
# This script shows the steps taken to cherry-pick commit e68aaf159d to feature-branch-1

echo "=== Cherry-pick e68aaf159d to feature-branch-1 ==="
echo
...
echo "Command: git cherry-pick e68aaf159dc65550d246d2e27b46ed3e843e3f1b"
...
echo ">>>>>>> e68aaf1 (feat: improve TestCopilotAutoCherryPickDemo with different validation)"
echo
...
echo "Final commit on feature-branch-1: 5700a7db9b54fb93b057c118d71abde9710d986c"
